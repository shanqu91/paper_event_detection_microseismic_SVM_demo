...
# training with both 1D and 2D features
####################################################################
...
with open('Data/clf_add2d.pkl', 'wb') as f:
    pickle.dump(clf, f)
with open('Data/rfecv_add2d.pkl', 'wb') as f:
    pickle.dump(rfecv, f)
with open('Data/selector_add2d.pkl', 'wb') as f:
